const LEVELS = [
  {
    ...
    passages: [
      ...
      { plain: "Компас изобрели в Китае более двух тысяч лет назад.", stressed: "Ко́мпас изобрели́ в Кита́е бо́лее двух ты́сяч лет наза́д.", en: "The compass was invented in China more than two thousand years ago." },
      { plain: "Отпечатки пальцев уникальны даже у однояйцевых близнецов.", stressed: "Отпеча́тки па́льцев уника́льны да́же у однояйцевы́х близнецо́в.", en: "Fingerprints are unique even in identical twins." },
      { plain: "Вода на Земле существовала ещё до появления динозавров.", stressed: "Вода́ на Земле́ существова́ла ещё до появле́ния диноза́вров.", en: "Water existed on Earth even before dinosaurs appeared." },
      { plain: "Дети растут быстрее всего в первый год жизни.", stressed: "Де́ти расту́т быстре́е всего́ в пе́рвый год жи́зни.", en: "Children grow fastest of all in their first year of life." },
      { plain: "Мороженое ели ещё в Древнем Китае много веков назад.", stressed: "Моро́женое е́ли ещё в Дре́внем Кита́е мно́го веко́в наза́д.", en: "Ice cream was eaten as far back as ancient China, many centuries ago." }
    ]
  },
  {
    ...
    passages: [
      ...
      { plain: "Первые монеты появились в Малой Азии около двух тысяч семисот лет назад. До этого люди обменивались товарами напрямую, без денег.", stressed: "Пе́рвые моне́ты появи́лись в Ма́лой А́зии о́коло двух ты́сяч семисо́т лет наза́д. До э́того лю́ди обме́нивались това́рами напряму́ю, без де́нег.", en: "The first coins appeared in Asia Minor about two thousand seven hundred years ago. Before that, people exchanged goods directly, without money." },
      { plain: "Гены передаются от родителей к детям в виде длинных молекул ДНК. Каждая клетка тела содержит почти полную копию этой инструкции.", stressed: "Ге́ны передаю́тся от роди́телей к де́тям в ви́де дли́нных моле́кул ДНК. Ка́ждая кле́тка те́ла соде́ржит почти́ по́лную ко́пию э́той инстру́кции.", en: "Genes pass from parents to children as long DNA molecules. Almost every cell in the body carries a nearly complete copy of this instruction set." },
      { plain: "Звук распространяется в воде быстрее, чем в воздухе. Поэтому киты слышат друг друга на огромных расстояниях.", stressed: "Звук распространя́ется в воде́ быстре́е, чем в во́здухе. Поэ́тому ки́ты слы́шат друг дру́га на огро́мных расстоя́ниях.", en: "Sound travels faster through water than through air. That's why whales can hear each other across enormous distances." },
      { plain: "У новорождённых почти нет слёз, когда они плачут. Слёзные железы начинают полноценно работать лишь через несколько недель после рождения.", stressed: "У новорождённых почти́ нет слёз, когда́ они́ пла́чут. Слёзные же́лезы начина́ют полноце́нно рабо́тать лишь че́рез не́сколько неде́ль по́сле рожде́ния.", en: "Newborns have almost no tears when they cry. The tear glands don't work fully until a few weeks after birth." },
      { plain: "Мёд собирают пчёлы из нектара цветов. Одна пчела за свою жизнь производит лишь малую долю чайной ложки мёда.", stressed: "Мёд собира́ют пчёлы из некта́ра цвето́в. Одна́ пчела́ за свою́ жизнь произво́дит лишь ма́лую до́лю ча́йной ло́жки мёда.", en: "Honey is gathered by bees from flower nectar. One bee produces only a tiny fraction of a teaspoon of honey in its whole life." }
    ]
  },
  {
    ...
    passages: [
      ...
      { plain: "Великий шёлковый путь соединял Китай со странами Средиземноморья на протяжении многих веков. По нему перевозили не только шёлк, но и специи, бумагу и новые идеи. Караваны проходили через горы и пустыни, и путешествие могло занимать целые месяцы.", stressed: "Вели́кий шёлковый путь соединя́л Кита́й со стра́нами Средиземномо́рья на протяже́нии мно́гих веко́в. По нему́ перевози́ли не то́лько шёлк, но и спе́ции, бума́гу и но́вые иде́и. Карава́ны проходи́ли че́рез го́ры и пусты́ни, и путеше́ствие могло́ занима́ть це́лые ме́сяцы.", en: "The Great Silk Road connected China with the countries of the Mediterranean for many centuries. It carried not only silk but also spices, paper, and new ideas. Caravans crossed mountains and deserts, and the journey could take whole months." },
      { plain: "Некоторые люди генетически способны переваривать молоко во взрослом возрасте, а другие нет. Эта особенность связана с работой одного гена, который отвечает за фермент, расщепляющий молочный сахар. Она распространена по-разному в разных частях света в зависимости от того, как долго предки народа занимались скотоводством.", stressed: "Не́которые лю́ди генети́чески спосо́бны перева́ривать молоко́ во взро́слом во́зрасте, а други́е нет. Э́та осо́бенность свя́зана с рабо́той одного́ ге́на, кото́рый отвеча́ет за ферме́нт, расщепля́ющий моло́чный са́хар. Она́ распространена́ по-ра́зному в ра́зных частя́х све́та в зави́симости от того́, как до́лго пре́дки наро́да занима́лись скотово́дством.", en: "Some people are genetically able to digest milk as adults, and others aren't. This trait is tied to one gene responsible for the enzyme that breaks down milk sugar. It's distributed differently across different parts of the world, depending on how long a people's ancestors kept livestock." },
      { plain: "Вулканы существуют не только на Земле, но и на других планетах Солнечной системы. На спутнике Юпитера под названием Ио находятся самые активные вулканы, известные учёным. Извержения там происходят почти постоянно из-за сильного притяжения соседних тел.", stressed: "Вулка́ны существу́ют не то́лько на Земле́, но и на други́х плане́тах Со́лнечной систе́мы. На спу́тнике Юпи́тера под назва́нием И́о нахо́дятся са́мые акти́вные вулка́ны, изве́стные учёным. Изверже́ния там происхо́дят почти́ постоя́нно из-за си́льного притяже́ния сосе́дних тел.", en: "Volcanoes exist not only on Earth but also on other planets in the Solar System. On Jupiter's moon called Io are the most active volcanoes known to scientists. Eruptions there happen almost constantly because of the strong gravitational pull of nearby bodies." },
      { plain: "Дети начинают понимать значительно больше слов, чем могут произнести сами. Такое пассивное понимание речи обычно опережает активную речь на несколько месяцев. Поэтому даже молчаливый малыш может прекрасно понимать, о чём говорят взрослые вокруг.", stressed: "Де́ти начина́ют понима́ть значи́тельно бо́льше слов, чем мо́гут произнести́ са́ми. Тако́е пасси́вное понима́ние ре́чи обы́чно опережа́ет акти́вную речь на не́сколько ме́сяцев. Поэ́тому да́же молчали́вый малы́ш мо́жет прекра́сно понима́ть, о чём говоря́т взро́слые вокру́г.", en: "Children come to understand far more words than they can say themselves. This passive understanding of speech usually runs months ahead of active speech. So even a quiet baby can understand perfectly well what the adults around them are saying." },
      { plain: "Картофель родом из Южной Америки, а не из Европы, как многие думают. Его привезли в Европу только в шестнадцатом веке испанские мореплаватели. Сначала европейцы относились к картофелю с недоверием и долго не хотели его есть.", stressed: "Карто́фель ро́дом из Ю́жной Аме́рики, а не из Евро́пы, как мно́гие ду́мают. Его́ привезли́ в Евро́пу то́лько в шестна́дцатом ве́ке испа́нские мореплава́тели. Снача́ла европе́йцы относи́лись к карто́фелю с недове́рием и до́лго не хоте́ли его́ есть.", en: "The potato originally comes from South America, not from Europe as many people think. Spanish sailors only brought it to Europe in the sixteenth century. At first Europeans were distrustful of the potato and didn't want to eat it for a long time." }
    ]
  },
  {
    ...
    passages: [
      ...
      { plain: "Изобретение бумаги в древнем Китае произошло значительно раньше, чем в Европе, где долгое время продолжали писать на пергаменте из кожи животных. Технология изготовления бумаги оставалась в секрете на протяжении многих веков и распространялась очень медленно. Она попала на Ближний Восток, а затем и в Европу, только спустя столетия после своего появления. Благодаря более дешёвому материалу для письма книги постепенно становились доступнее.", stressed: "Изобрете́ние бума́ги в дре́внем Кита́е произошло́ значи́тельно ра́ньше, чем в Евро́пе, где до́лгое вре́мя продолжа́ли писа́ть на перга́менте из ко́жи живо́тных. Техноло́гия изготовле́ния бума́ги остава́лась в секре́те на протяже́нии мно́гих веко́в и распространя́лась о́чень ме́дленно. Она́ попа́ла на Бли́жний Восто́к, а зате́м и в Евро́пу, то́лько спустя́ столе́тия по́сле своего́ появле́ния. Благодаря́ бо́лее дешёвому материа́лу для письма́ кни́ги постепе́нно станови́лись досту́пнее.", en: "The invention of paper in ancient China happened significantly earlier than in Europe, where people continued writing on parchment made from animal skin for a long time. The technology for making paper remained secret for many centuries and spread very slowly. It reached the Middle East, and then Europe, only centuries after it first appeared. Thanks to a cheaper writing material, books gradually became more accessible." },
      { plain: "Учёные секвенировали первый полный геном человека в начале двухтысячных годов, и этот проект занял более десяти лет совместной работы множества лабораторий по всему миру. С тех пор технологии значительно подешевели, и сегодня прочитать чей-то геном можно всего за несколько дней и за гораздо меньшие деньги. Это открыло дорогу для так называемой персонализированной медицины, при которой лечение подбирается с учётом генетических особенностей конкретного пациента. Тем не менее расшифровка самой последовательности ДНК — это лишь первый шаг, а понимание того, как именно работают все эти гены вместе, остаётся сложной задачей.", stressed: "Учёные секвени́ровали пе́рвый по́лный гено́м челове́ка в нача́ле двухты́сячных годо́в, и э́тот прое́кт заня́л бо́лее десяти́ лет совме́стной рабо́ты мно́жества лаборато́рий по всему́ ми́ру. С тех пор техноло́гии значи́тельно подешеве́ли, и сего́дня прочита́ть чей-то гено́м мо́жно всего́ за не́сколько дней и за гора́здо ме́ньшие де́ньги. Э́то откры́ло доро́гу для так называ́емой персонализи́рованной медици́ны, при кото́рой лече́ние подбира́ется с учётом генети́ческих осо́бенностей конкре́тного пацие́нта. Тем не ме́нее расшифро́вка са́мой после́довательности ДНК — э́то лишь пе́рвый шаг, а понима́ние того́, как и́менно рабо́тают все э́ти ге́ны вме́сте, остаётся сло́жной зада́чей.", en: "Scientists sequenced the first complete human genome in the early 2000s, and the project took more than ten years of joint work by many laboratories worldwide. Since then, the technology has become much cheaper, and today reading someone's genome can take just a few days and far less money. This opened the way for so-called personalized medicine, in which treatment is chosen based on a specific patient's genetic makeup. Even so, decoding the DNA sequence itself is only the first step, and understanding exactly how all these genes work together remains a difficult task." },
      { plain: "Атмосфера Земли защищает всё живое от вредного космического излучения и от большинства метеоритов, которые сгорают, не долетая до поверхности. Она состоит из нескольких слоёв, каждый из которых выполняет свою особую роль. Например, озоновый слой поглощает значительную часть ультрафиолетового излучения Солнца, опасного для живых клеток. Без этой невидимой защиты жизнь в её современном виде вряд ли была бы возможна.", stressed: "Атмосфе́ра Земли́ защища́ет всё живо́е от вре́дного косми́ческого излуче́ния и от большинства́ метеори́тов, кото́рые сгора́ют, не долета́я до пове́рхности. Она́ состои́т из не́скольких слоёв, ка́ждый из кото́рых выполня́ет свою́ осо́бую роль. Наприме́р, озо́новый слой поглоща́ет значи́тельную часть ультрафиоле́тового излуче́ния Со́лнца, опа́сного для живы́х кле́ток. Без э́той неви́димой защи́ты жизнь в её совреме́нном ви́де вряд ли была́ бы возмо́жна.", en: "Earth's atmosphere protects all living things from harmful cosmic radiation and from most meteorites, which burn up before reaching the surface. It consists of several layers, each playing its own particular role. For example, the ozone layer absorbs a significant part of the Sun's ultraviolet radiation, which is dangerous to living cells. Without this invisible shield, life in its modern form would hardly be possible." },
      { plain: "Игра занимает намного больше места в развитии ребёнка, чем может показаться на первый взгляд. Именно во время игры дети учатся договариваться, делиться, справляться с разочарованием и придумывать собственные правила. Простая игра в прятки или в кубики развивает память, воображение и способность планировать действия наперёд. Поэтому специалисты по детскому развитию считают игру не просто развлечением, а важной формой обучения.", stressed: "Игра́ занима́ет намно́го бо́льше ме́ста в разви́тии ребёнка, чем мо́жет показа́ться на пе́рвый взгляд. И́менно во вре́мя игры́ де́ти у́чатся догова́риваться, дели́ться, справля́ться с разочарова́нием и приду́мывать со́бственные пра́вила. Просто́е игра́ в пря́тки и́ли в ку́бики развива́ет па́мять, воображе́ние и спосо́бность плани́ровать де́йствия наперёд. Поэ́тому специали́сты по де́тскому разви́тию счита́ют игру́ не про́сто развлече́нием, а ва́жной фо́рмой обуче́ния.", en: "Play takes up far more space in a child's development than it might seem at first glance. It's precisely during play that children learn to negotiate, share, cope with disappointment, and invent their own rules. Something as simple as hide-and-seek or building blocks develops memory, imagination, and the ability to plan ahead. That's why child development specialists consider play not just entertainment but an important form of learning." },
      { plain: "Хлеб является одним из самых древних продуктов, приготовленных человеком, и его история насчитывает тысячи лет. Первый хлеб, вероятно, представлял собой простую лепёшку из перемолотых зёрен и воды, без каких-либо дрожжей. Позже люди заметили, что тесто, оставленное на некоторое время, само начинает подниматься благодаря диким дрожжам из воздуха. Так постепенно появился привычный нам пышный хлеб, а вместе с ним и целая культура выпечки в разных уголках мира.", stressed: "Хлеб явля́ется одни́м из са́мых дре́вних проду́ктов, приготовленных челове́ком, и его́ исто́рия насчи́тывает ты́сячи лет. Пе́рвый хлеб, вероя́тно, представля́л собо́й просту́ю лепёшку из перемо́лотых зёрен и воды́, без каки́х-либо дрожже́й. По́зже лю́ди заме́тили, что те́сто, оста́вленное на не́которое вре́мя, само́ начина́ет поднима́ться благодаря́ ди́ким дрожжа́м из во́здуха. Так постепе́нно появи́лся привы́чный нам пы́шный хлеб, а вме́сте с ним и це́лая культу́ра вы́печки в ра́зных уголка́х ми́ра.", en: "Bread is one of the oldest foods prepared by humans, with a history spanning thousands of years. The first bread was probably a simple flatbread made from ground grain and water, with no yeast at all. Later, people noticed that dough left standing for a while began rising on its own, thanks to wild yeast from the air. That's how the fluffy bread we know gradually came about, along with an entire baking culture in different corners of the world." }
    ]
  },
  {
    ...
    passages: [
      ...
      { plain: "Расшифровка египетских иероглифов долгое время оставалась одной из главных загадок археологии, пока в тысяча семьсот девяносто девятом году французские солдаты не обнаружили Розеттский камень с одним и тем же текстом на трёх разных письменностях. Благодаря тому что один из этих текстов был написан на уже известном древнегреческом языке, учёные получили ключ к пониманию иероглифов. Тем не менее полная расшифровка заняла ещё более двадцати лет напряжённой работы, прежде чем французский исследователь Жан-Франсуа Шампольон смог представить систематическое объяснение египетской письменности. Это открытие полностью изменило представления историков о жизни древнего Египта.", stressed: "Расшифро́вка еги́петских иеро́глифов до́лгое вре́мя остава́лась одно́й из гла́вных зага́док археоло́гии, пока́ в ты́сяча семьсо́т девяно́сто девя́том году́ францу́зские солда́ты не обнару́жили Розе́ттский ка́мень с одни́м и тем же те́кстом на трёх ра́зных пи́сьменностях. Благодаря́ тому́ что оди́н из э́тих те́кстов был напи́сан на уже́ изве́стном древнегре́ческом языке́, учёные получи́ли ключ к понима́нию иеро́глифов. Тем не ме́нее по́лная расшифро́вка заняла́ ещё бо́лее двадцати́ лет напряжённой рабо́ты, пре́жде чем францу́зский иссле́дователь Жан-Франсуа́ Шампольо́н смог предста́вить система́тическое объясне́ние еги́петской пи́сьменности. Э́то откры́тие по́лностью измени́ло представле́ния исто́риков о жи́зни дре́внего Еги́пта.", en: "Deciphering Egyptian hieroglyphs long remained one of archaeology's great mysteries, until in 1799 French soldiers discovered the Rosetta Stone, bearing the same text in three different scripts. Because one of those texts was written in the already-known ancient Greek language, scholars got a key to understanding the hieroglyphs. Even so, full decipherment took more than twenty more years of intense work before the French scholar Jean-François Champollion could present a systematic account of Egyptian writing. This discovery completely transformed historians' understanding of life in ancient Egypt." },
      { plain: "Хотя близнецовый метод долгое время считался одним из лучших способов отделить влияние генов от влияния среды, современные исследователи признают, что провести чёткую границу между этими двумя факторами почти никогда не удаётся полностью. Сравнивая однояйцевых близнецов, у которых гены полностью совпадают, с разнояйцевыми, у которых совпадает лишь примерно половина генов, учёные могут оценить, насколько тот или иной признак объясняется наследственностью. Однако даже однояйцевые близнецы, выросшие в одной семье, нередко заметно различаются по характеру и здоровью, что указывает на огромную роль случайных факторов и условий жизни. Именно поэтому современная генетика всё чаще говорит не о простом противопоставлении природы и воспитания, а о их сложном, переплетённом взаимодействии.", stressed: "Хотя́ близнецо́вый ме́тод до́лгое вре́мя счита́лся одни́м из лу́чших спо́собов отдели́ть влия́ние ге́нов от влия́ния среды́, совреме́нные иссле́дователи признаю́т, что провести́ чёткую грани́цу ме́жду э́тими двумя́ фа́кторами почти́ никогда́ не удаётся по́лностью. Сра́внивая однояйцевы́х близнецо́в, у кото́рых ге́ны по́лностью совпада́ют, с разнояйцевы́ми, у кото́рых совпада́ет лишь приме́рно полови́на ге́нов, учёные мо́гут оцени́ть, наско́лько тот и́ли ино́й при́знак объясня́ется насле́дственностью. Одна́ко да́же однояйцевы́е близнецы́, вы́росшие в одно́й семье́, нере́дко заме́тно различа́ются по хара́ктеру и здоро́вью, что ука́зывает на огро́мную роль случа́йных фа́кторов и усло́вий жи́зни. И́менно поэ́тому совреме́нная гене́тика всё ча́ще говори́т не о просто́м противопоставле́нии приро́ды и воспита́ния, а об их сло́жном, переплетённом взаимоде́йствии.", en: "Although the twin-study method has long been considered one of the best ways to separate the influence of genes from that of environment, modern researchers acknowledge that a clean line between these two factors can almost never be fully drawn. By comparing identical twins, whose genes fully match, with fraternal twins, who share only about half their genes, scientists can estimate how much a given trait is explained by heredity. However, even identical twins raised in the same family often differ noticeably in personality and health, which points to the huge role of chance factors and life circumstances. That's exactly why modern genetics increasingly speaks not of a simple nature-versus-nurture split, but of their complex, intertwined interaction." },
      { plain: "Хотя чёрные дыры невозможно увидеть напрямую, поскольку даже свет не может вырваться из-под их притяжения, учёным всё же удалось получить первое настоящее изображение окрестностей чёрной дыры в две тысячи девятнадцатом году. Для этого была создана целая сеть радиотелескопов, расположенных в разных точках планеты, которые работали одновременно, как будто это был один гигантский телескоп размером с Землю. Полученное изображение показало яркое кольцо раскалённого вещества, окружающее тёмную область в самом центре. Этот результат стал возможен благодаря десятилетиям теоретических расчётов и международному сотрудничеству сотен учёных.", stressed: "Хотя́ чёрные ды́ры невозмо́жно уви́деть напряму́ю, поско́льку да́же свет не мо́жет вы́рваться из-под их притяже́ния, учёным всё же удало́сь получи́ть пе́рвое настоя́щее изображе́ние окре́стностей чёрной дыры́ в две ты́сячи девятна́дцатом году́. Для э́того была́ со́здана це́лая сеть радиотелеско́пов, расположённых в ра́зных то́чках плане́ты, кото́рые рабо́тали одновреме́нно, как бу́дто э́то был оди́н гига́нтский телеско́п разме́ром с Зе́млю. Полу́ченное изображе́ние показа́ло я́ркое кольцо́ раскалённого вещества́, окружа́ющее тёмную о́бласть в са́мом це́нтре. Э́тот результа́т стал возмо́жен благодаря́ десятиле́тиям теорети́ческих расчётов и междунаро́дному сотру́дничеству со́тен учёных.", en: "Although black holes can't be seen directly, since not even light can escape their pull, scientists still managed to obtain the first real image of a black hole's surroundings in 2019. For this, an entire network of radio telescopes located at different points on the planet was set up, all working simultaneously as if they were one giant telescope the size of Earth. The resulting image showed a bright ring of superheated matter surrounding a dark region at the very center. This result became possible thanks to decades of theoretical calculations and international cooperation among hundreds of scientists." },
      { plain: "Хотя каждый ребёнок развивается в своём собственном темпе, исследователи детского развития выделяют определённые ориентиры, которые помогают понять, идёт ли развитие в целом типичным путём. Важно при этом, что довольно широкий разброс в сроках освоения тех или иных навыков считается совершенно нормальным явлением, и один и тот же ребёнок может опережать сверстников в одной области, например в речи, и немного отставать в другой, например в моторике. Специалисты подчёркивают, что сравнение с усреднёнными нормами полезно скорее как общий ориентир, а не как повод для тревоги при небольших отклонениях. Гораздо важнее внимательное, тёплое отношение к ребёнку и то, насколько он в целом счастлив и любопытен к окружающему миру.", stressed: "Хотя́ ка́ждый ребёнок развива́ется в своём со́бственном те́мпе, иссле́дователи де́тского разви́тия выделя́ют определённые ориенти́ры, кото́рые помога́ют поня́ть, идёт ли разви́тие в це́лом типи́чным путём. Ва́жно при э́том, что дово́льно широ́кий разбро́с в сро́ках освое́ния тех и́ли ины́х на́выков счита́ется соверше́нно норма́льным явле́нием, и оди́н и тот же ребёнок мо́жет опережа́ть све́рстников в одно́й о́бласти, наприме́р в ре́чи, и немно́го отстава́ть в друго́й, наприме́р в мото́рике. Специали́сты подчёркивают, что сравне́ние с усреднёнными но́рмами поле́зно скоре́е как о́бщий ориенти́р, а не как по́вод для трево́ги при небольши́х отклоне́ниях. Гора́здо важне́е внима́тельное, тёплое отноше́ние к ребёнку и то, наско́лько он в це́лом сча́стлив и любопы́тен к окружа́ющему ми́ру.", en: "Although every child develops at their own pace, researchers of child development identify certain milestones that help gauge whether development is following a broadly typical path. It's important, though, that a fairly wide range in the timing of acquiring various skills is considered entirely normal, and the same child may be ahead of peers in one area, say speech, while a bit behind in another, say motor skills. Specialists stress that comparison with average norms is useful mainly as a general guide, not as a reason for alarm over minor deviations. Far more important is attentive, warm treatment of the child and how happy and curious they are, overall, about the world around them." },
      { plain: "Ферментация — процесс, при котором микроорганизмы, такие как бактерии или дрожжи, преобразуют сахара в пище в другие вещества, — использовалась людьми для сохранения и улучшения вкуса продуктов задолго до того, как кто-либо понимал, что происходит на химическом уровне. Благодаря ферментации появились такие разные продукты, как квашеная капуста, йогурт, соевый соус и вино, хотя развивались эти традиции независимо друг от друга в самых разных уголках света. Помимо более долгого срока хранения, ферментированные продукты нередко становятся более лёгкими для усвоения и приобретают новые, более сложные вкусы. Современные учёные, изучающие микробиом человека, всё больше интересуются тем, как такие продукты могут влиять на здоровье кишечника.", stressed: "Ферме́нтация — проце́сс, при кото́ром микрооргани́змы, таки́е как бакте́рии и́ли дрожжи́, преобразу́ют са́хара в пи́ще в други́е вещества́, — испо́льзовалась людьми́ для сохране́ния и улучше́ния вку́са проду́ктов задо́лго до того́, как кто́-либо понима́л, что происхо́дит на хими́ческом у́ровне. Благодаря́ фермента́ции появи́лись таки́е ра́зные проду́кты, как ква́шеная капу́ста, йо́гурт, со́евый со́ус и вино́, хотя́ развива́лись э́ти тради́ции незави́симо друг от дру́га в са́мых ра́зных уголка́х све́та. Поми́мо бо́лее до́лгого сро́ка хране́ния, ферменти́рованные проду́кты нере́дко стано́вятся бо́лее лёгкими для усвое́ния и приобрета́ют но́вые, бо́лее сло́жные вку́сы. Совреме́нные учёные, изуча́ющие микробио́м челове́ка, всё бо́льше интересу́ются тем, как таки́е проду́кты мо́гут влия́ть на здоро́вье кише́чника.", en: "Fermentation — the process by which microorganisms such as bacteria or yeast convert sugars in food into other substances — was used by people to preserve food and improve its flavor long before anyone understood what was happening on a chemical level. Fermentation gave rise to such varied foods as sauerkraut, yogurt, soy sauce, and wine, even though these traditions developed independently of one another in very different corners of the world. Besides a longer shelf life, fermented foods often become easier to digest and take on new, more complex flavors. Modern scientists studying the human microbiome are increasingly interested in how such foods may affect gut health." }
    ]
  }
];
